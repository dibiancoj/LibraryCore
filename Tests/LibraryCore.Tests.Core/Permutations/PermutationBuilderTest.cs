...
public class PermutationBuilderTest
{
    ...
    public void PermutationTestExclusive1()
    {
        ...
        Assert.Equal(result.Length, PermutationBuilder.TotalNumberOfPermutationCombinations(choices, lengthToTest, isExclusive));

        //check the overload with the count
        Assert.Equal(result.Length, PermutationBuilder.TotalNumberOfPermutationCombinations(choices.Length, lengthToTest, isExclusive));
