...
public class MongoRegistrationTest
{
    ...
    [InlineData("root", "password123", "mydocdbserver", "secondary", true, "mongodb://root:password123@mydocdbserver:27017/?ssl=true&retryWrites=False&sslVerifyCertificate=false")]
    [Theory]
    ...
    [InlineData("root", "password123", "mydocdbserver", true, 27017, "mongodb://root:password123@mydocdbserver:27017/?ssl=true&retryWrites=False&sslVerifyCertificate=false")]
    [Theory]
