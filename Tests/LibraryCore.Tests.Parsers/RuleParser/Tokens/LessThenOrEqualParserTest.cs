...
public class LessThenOrEqualParserTest(RuleParserFixture ruleParserFixture) : IClassFixture<RuleParserFixture>
{
    ...
    [Fact]
    public void CreateTokenNotImplemented() => Assert.Throws<NotImplementedException>(() => new LessThenOrEqualToken().CreateExpression(ImmutableList<ParameterExpression>.Empty));
